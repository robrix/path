...
runElab :: ( Carrier sig m
        ...
        -> m (Set.Set Equation, (Resources, Term (Core (Typed Name) (Typed QName)) Type))
...
elabModule :: ( Carrier sig m
           ...
           -> m (Module QName (Set.Set Equation, (Resources, Term (Core (Typed Name) (Typed QName)) Type)))
elabModule m = do
...
elabDecl :: ( Carrier sig m
         ...
         -> m (Decl QName (Set.Set Equation, (Resources, Term (Core (Typed Name) (Typed QName)) Type)))
elabDecl = \case
