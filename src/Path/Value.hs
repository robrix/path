...
--   prop> quote i ((free (Local (Name s)) $$ free (Local (Name t))) $$ free (Local (Name u))) == In (In (In (Core.Free (Local (Name s))) () Core.:$ In (Core.Free (Local (Name t))) ()) () Core.:$ In (Core.Free (Local (Name u))) ()) ()
